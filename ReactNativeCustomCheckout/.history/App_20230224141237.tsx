...
function App(): JSX.Element {
  ...
  /**
   * This methods will invoke native module (RNBridgeModule) doPayment method.
   * From there , it will start Payment flow.
   * Once payment completed(fail/success), it will return rsult as callback.
   * Currently, we are returing paymentReturnUrl, paymentstatus from there.
   */
  function startCheckout() {
    ...
    PaymentSDKApi.doPayment(
      ...
      (paymentReturnUrl: any, paymentStatus: any) => {
        ...
        console.log('Payment ReturnUrl', paymentReturnUrl);
